...
| --- | --- | ---: |
| Lemma 1: XOR projection structural guarantees | Projection construction, path/reachability lifting, no-dead/safeness/soundness wrappers, indexed pattern constructors, original proper-completion transfer, indexed branch-completion constructors, and elementwise trace-to-subtype closure wrappers are checked; remaining work is to prove the elementwise branch-exclusivity facts from the XOR pattern itself. | 86% |
